...
export default function AddImportantScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      Alert.alert('Sukses', 'Tugas penting berhasil disimpan', [
  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.formCard}>
        <Text style={[styles.badge, { backgroundColor: Colors.important }]}>PENTING</Text>
        ...
        <TouchableOpacity 
          style={[styles.saveButton, { backgroundColor: Colors.important }]} 
          onPress={handleSave}
        >
